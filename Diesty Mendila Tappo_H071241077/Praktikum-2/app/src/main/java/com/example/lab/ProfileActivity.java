...
public class ProfileActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        boolean isOwnProfile = (username == null || username.equals("dies_"));
        ...
        if (tvToolbarName != null)
            tvToolbarName.setText(isOwnProfile ? "dies_" : username);

        // ── Nama lengkap ──────────────────────────────────────────────────────
        TextView tvFullName = findViewById(R.id.tv_full_name);
        if (tvFullName != null)
            tvFullName.setText(isOwnProfile ? "diesty mendila"
        ...
        if (isOwnProfile) {
            if (tvFollowers != null) tvFollowers.setText("746");
            if (tvFollowing != null) tvFollowing.setText("186");
        ...
        if (tvFollowedBy != null) {
            if (isOwnProfile) {
                tvFollowedBy.setText(
                        "Diikuti oleh witry_1606, taniasalsabilla_, dan 2 lainnya");
            } else if (targetUser != null) {
